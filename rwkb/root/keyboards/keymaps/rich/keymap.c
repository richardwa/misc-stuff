...
[_OT] = { /* mouse layer */
  {KC_TRNS, KC_TRNS, KC_MS_U, KC_WH_U, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TG(_GM) },
...
[_GM] = { /* other */
  {KC_TAB,  RESET,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_F1,   KC_F2,   KC_F3,   KC_F4,   TG(_GM)},
  {KC_ESC,  KC_A,    BL_TOGG,    BL_STEP,    KC_F,    KC_G,    KC_H,    KC_1,    KC_2,    KC_3,    KC_4,    KC_TRNS},
  {KC_LSFT, KC_Z,    RGB_TOG,    RGB_MOD,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT},
